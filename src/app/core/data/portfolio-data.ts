...
export const PROJECTS: Project[] = [
  {
    id: 'live-train-delay-tracker',
    title: 'Live Train Delay Tracker',
    subtitle: 'Manifest V3 Browser Extension & Real-Time Rail Analytics',
    category: 'fullstack',
    description: 'A production Manifest V3 browser extension for real-time Indian Railways running status and delay analytics directly inside train booking platforms (ConfirmTkt, IRCTC). Engineered with RxJS mutation streams, background service worker gateways, and glassmorphism HUD cards.',
    impact: 'Published on Microsoft Edge Add-ons Store. Delivers sub-second delay updates with strict 50 MB local caching and zero UI thread blocking.',
    technologies: ['Chrome Extension (MV3)', 'TypeScript', 'RxJS', 'Vite', 'Service Workers', 'Playwright', 'REST APIs'],
    imageUrl: '/assets/img/portfolio/chrome-extension.webp',
    demoUrl: 'https://microsoftedge.microsoft.com/addons/detail/live-train-delay-tracker/pknpnmpklieceipblhgfniafbcmpakao',
    githubUrl: 'https://github.com/RajdipGhosh99/live-train-running-status-browser-extension',
    isFeatured: true
  },
  {
    ...
    imageUrl: '/assets/img/portfolio/meter.webp',
    isFeatured: true
  },
  {
    ...
    imageUrl: '/assets/img/portfolio/radial-bar.webp',
    isFeatured: true
  },
  {
    id: 'xempla-core',
    ...
    imageUrl: '/assets/img/portfolio/linear-bar.webp',
    isFeatured: true
  },
  {
    id: 'gmap-clone',
    ...
    imageUrl: '/assets/img/portfolio/gmap-clone.webp',
  ...
  },
  {
    ...
    imageUrl: '/assets/img/portfolio/instaclone.webp',
  ...
  },
  {
    ...
    imageUrl: '/assets/img/portfolio/studentcdc.webp',
  ...
  },
  {
    ...
    imageUrl: '/assets/img/portfolio/stopwatch.webp',
    isFeatured: false
  }
];
